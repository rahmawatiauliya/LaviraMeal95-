...
export default function ProfilKantinScreen({ navigation }) {
  ...
  const [userData, setUserData] = useState({
    ...
    displayJabatan: 'Pemilik Kantin / Operator',
    id: '',
    region: 'Memuat...'
  });
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      const response = await apiClient.post('auth/update_profile.php', {
        ...
        nama_kantin: editedData.nama, // Asumsi nama user adalah nama kantin
      ...
      if (response.data.status === 'success') {
        ...
        setUserData(newData);
        setEditModal(false);
        Alert.alert("Berhasil", "Data profil kantin telah diperbarui.");
      } else {
    ...
    <View style={styles.container}>
      ...
      >
              ...
              <View style={styles.profileMaster}>
                 <TouchableOpacity style={styles.mainAvatarWrap} onPress={pickImage}>
                    ...
                    <View style={styles.avatarBorder}>
                       {profileImage ? (
                         ...
                         <View style={styles.initialsBox}>
                           <Text style={styles.initialsTxt}>{userData.nama?.[0] || 'K'}</Text>
                         </View>
                       )}
                    </View>
                  ...
                  <View style={styles.roleBadge}>
                    <Text style={styles.roleBadgeTxt}>OPERATOR KANTIN MITRA</Text>
                  </View>
              </View>
           </ImageBackground>
        </View>
        ...
        <View style={styles.idCardWrapper}>
           <View style={styles.premiumCard}>
              ...
              <View style={styles.cardHeaderArea}>
                  <View>
                    <Text style={styles.cardTag}>IDENTITAS RESMI KANTIN</Text>
                    <Text style={styles.cardInstitution}>{userData.displayLembaga}</Text>
                  </View>
                 <View style={styles.digitalSeal}>
                    <MaterialCommunityIcons name="store-check" size={28} color="rgba(255,255,255,0.2)" />
                 </View>
              </View>
              ...
              <View style={styles.cardMainInfo}>
                  <View style={styles.infoCol}>
                    <View style={styles.idItemBox}>
                       <Text style={styles.idItemLabel}>KODE MERCHANT</Text>
                       <Text style={styles.idItemVal}>{userData.username || 'KNT-' + userData.id?.slice(0,5)}</Text>
                    </View>
                    <View style={styles.idItemBox}>
                       <Text style={styles.idItemLabel}>STATUS OPERASIONAL</Text>
                       <Text style={styles.idItemVal}>AKTIF & TERVERIFIKASI</Text>
                    </View>
                  </View>
                 ...
                 <View style={styles.cardBarcodeArea}>
                    ...
                    <Text style={styles.barcodeLabel}>SCAN DANA</Text>
                 </View>
              </View>

              <View style={styles.cardBottomBar}>
                 <View style={styles.validityBox}>
                    <Text style={styles.idItemLabel}>KEAMANAN TRANSAKSI</Text>
                    <View style={styles.authRow}>
                       <View style={styles.greenPulse} />
                       <Text style={styles.authStatus}>ENKRIPSI AKTIF</Text>
                    </View>
                 </View>
                 <View style={styles.digitalSignature}>
                    <Text style={styles.signatureName}>{userData.nama}</Text>
                    <Text style={styles.signatureSubtitle}>TANDA TANGAN DIGITAL</Text>
                 </View>
              </View>
           </View>
        </View>
        ...
        <View style={styles.tilesContainer}>
           <Text style={styles.sectionTitleTxt}>PENGATURAN KANTIN</Text>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  setEditedData({ 
                    ...
                    jabatan: userData.displayJabatan || 'Pemilik Kantin'
                  });
                  setEditModal(true);
                }}
              >
        ...
        <View style={styles.detailListSection}>
           <Text style={styles.sectionTitleTxt}>SPESIFIKASI OPERASIONAL</Text>
           <View style={styles.infoHub}>
              <View style={styles.infoHubItem}>
                 ...
                 <View style={styles.hubContent}>
                    <Text style={styles.hubLabel}>EMAIL OPERASIONAL</Text>
                    <Text style={styles.hubVal}>{userData.email || 'N/A'}</Text>
                 </View>
              </View>
              <View style={styles.hubDivider} />
              <View style={styles.infoHubItem}>
                 <View style={styles.hubIcon}>
                    <Feather name="map-pin" size={18} color={TEXT_MUTED} />
                 </View>
                  <View style={styles.hubContent}>
                    <Text style={styles.hubLabel}>LOKASI SEKOLAH</Text>
                    <Text style={styles.hubVal}>{userData.displayLembaga}</Text>
                  </View>
              </View>
              <View style={styles.hubDivider} />
              <View style={styles.infoHubItem}>
                 <View style={styles.hubIcon}>
                    <Feather name="database" size={18} color={TEXT_MUTED} />
                 </View>
                 <View style={styles.hubContent}>
                    <Text style={styles.hubLabel}>ID MERCHANT GLOBAL</Text>
                    <Text style={styles.hubVal}>{userData.id || 'N/A'}</Text>
                 </View>
              </View>
           </View>
        </View>
        ...
        <TouchableOpacity style={styles.exitActionBtn} onPress={handleLogout}>
           ...
           <Text style={styles.exitActionTxt}>KELUAR SESI</Text>
        </TouchableOpacity>
        ...
        <View style={styles.brandingFooter}>
           <Image 
             ...
             resizeMode="contain"
           />
           <Text style={styles.footerVerTxt}>LaviraMeal Merchant v2.5.0</Text>
           ...
           <View style={styles.sheetMain}>
              ...
              <View style={styles.sheetHead}>
                 <View>
                    ...
                    <Text style={styles.sheetSubTxt}>Perbarui spesifikasi profil kantin</Text>
                 </View>
              ...
              <ScrollView style={styles.sheetFormScroll} showsVerticalScrollIndicator={false}>
                 <View style={styles.formItem}>
                    <Text style={styles.formItemLabel}>NAMA KANTIN / PEMILIK</Text>
                    <View style={styles.formInputWrap}>
                       <Feather name="store" size={18} color={TEXT_MUTED} />
                       <TextInput 
                 ...
                 <View style={styles.formItem}>
                    <Text style={styles.formItemLabel}>JABATAN / PERAN</Text>
                    <View style={styles.formInputWrap}>
...
const styles = StyleSheet.create({
  ...
  initialsBox: { width: '100%', height: '100%', backgroundColor: GOLD, justifyContent: 'center', alignItems: 'center' },
  ...
  cardTag: { color: GOLD, fontSize: 9, fontWeight: '900', letterSpacing: 2, marginBottom: 5 },
