...
export default function ProfilSekolahScreen({ navigation }) {
    ...
    try {
      ...
      if (dataStr) {
        ...
        setUserData(prev => ({
          ...prev,
          ...parsed,
          displayLembaga: parsed.nama_sekolah || 'INSTITUSI PENDIDIKAN',
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      const response = await apiClient.post('auth/update_profile.php', {
        ...
        nama_sekolah: editedData.nama_sekolah || editedData.displayLembaga,
        npsn: editedData.npsn,
              ...
              <View style={styles.profileMaster}>
                 <TouchableOpacity style={styles.mainAvatarWrap} onPress={pickImage}>
                  ...
                  <View style={styles.roleBadge}>
                    <Text style={styles.roleBadgeTxt}>ADMINISTRATOR SEKOLAH</Text>
                  </View>
              </View>
           </ImageBackground>
        </View>
        ...
        <View style={styles.idCardWrapper}>
           <View style={styles.premiumCard}>
              ...
              <View style={styles.cardHeaderArea}>
                  <View>
                    <Text style={styles.cardTag}>IDENTITAS RESMI SEKOLAH</Text>
              ...
              <View style={styles.cardMainInfo}>
                  <View style={styles.infoCol}>
                    <View style={styles.idItemBox}>
                       <Text style={styles.idItemLabel}>NPSN / REGISTRASI</Text>
                       <Text style={styles.idItemVal}>{userData.npsn || 'N/A'}</Text>
                    </View>
                    <View style={styles.idItemBox}>
                       <Text style={styles.idItemLabel}>PERAN OTORITAS</Text>
                       <Text style={styles.idItemVal}>{userData.displayJabatan}</Text>
                    </View>
                  </View>
                 ...
                 <View style={styles.cardBarcodeArea}>
                    ...
                    <Text style={styles.barcodeLabel}>ID AMAN</Text>
                 </View>
              </View>
              ...
              <View style={styles.cardBottomBar}>
                 <View style={styles.validityBox}>
                    ...
                    <View style={styles.authRow}>
                       ...
                       <Text style={styles.authStatus}>TERVERIFIKASI PENUH</Text>
                    </View>
                 </View>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  setEditedData({ 
                    ...
                    nip: userData.nip,
                    npsn: userData.npsn,
                    nama_sekolah: userData.nama_sekolah || userData.displayLembaga
                  });
                  setEditModal(true);
                }}
              >
           ...
           <View style={styles.infoHub}>
              <View style={styles.infoHubItem}>
                 ...
                 <View style={styles.hubContent}>
                    <Text style={styles.hubLabel}>EMAIL KONTAK</Text>
              ...
              <View style={styles.infoHubItem}>
                 <View style={styles.hubIcon}>
                  ...
                  <View style={styles.hubContent}>
                    <Text style={styles.hubLabel}>WILAYAH GEOGRAFIS</Text>
                    <Text style={styles.hubVal}>{userData.region}</Text>
                  </View>
              </View>
              <View style={styles.hubDivider} />
              <View style={styles.infoHubItem}>
                 ...
                 <View style={styles.hubContent}>
                    <Text style={styles.hubLabel}>ID SISTEM GLOBAL</Text>
           ...
           <View style={styles.sheetMain}>
              ...
              <View style={styles.sheetHead}>
                 <View>
                    ...
                    <Text style={styles.sheetSubTxt}>Perbarui spesifikasi profil sekolah</Text>
                 </View>
              ...
              <ScrollView style={styles.sheetFormScroll} showsVerticalScrollIndicator={false}>
                 <View style={styles.formItem}>
                    <Text style={styles.formItemLabel}>NAMA LENGKAP (ADMIN)</Text>
                 ...
                 <View style={styles.formItem}>
                    <Text style={styles.formItemLabel}>NAMA SEKOLAH</Text>
                    <View style={styles.formInputWrap}>
                       <Feather name="home" size={18} color={TEXT_MUTED} />
                       <TextInput 
                         style={styles.formTextInput} 
                         value={editedData.nama_sekolah}
                         onChangeText={(txt) => setEditedData({...editedData, nama_sekolah: txt})}
                       />
                    </View>
                 </View>

                 <View style={styles.formItem}>
                    <Text style={styles.formItemLabel}>NPSN SEKOLAH</Text>
                    <View style={styles.formInputWrap}>
                       <Feather name="shield" size={18} color={TEXT_MUTED} />
                       <TextInput 
                         style={styles.formTextInput} 
                         value={editedData.npsn}
                         onChangeText={(txt) => setEditedData({...editedData, npsn: txt})}
      ...
      <View style={styles.bottomNav}>
        <View style={styles.bottomNavInner}>
          ...
          <TouchableOpacity style={styles.navItem} onPress={() => navigation.navigate('ManajemenKelas')}>
            <Ionicons name="layers-outline" size={24} color={TEXT_MUTED} />
