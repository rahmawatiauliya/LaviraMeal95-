...
export default function ProfilSiswaScreen({ navigation }) {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (response.data.status === 'success') {
        const updated = { ...userData, nama: editedData.nama, email: editedData.email };
              ...
              <View style={styles.profileMaster}>
                 <TouchableOpacity style={styles.mainAvatarWrap} onPress={pickImage}>
                    ...
                    <View style={styles.avatarBorder}>
                       {profileImage ? (
                         ...
                         <View style={styles.initialsBox}>
                           <Text style={styles.initialsTxt}>{userData.nama?.[0] || 'S'}</Text>
                         </View>
                       )}
                    </View>
                  ...
                  <View style={styles.roleBadge}>
                    <Text style={styles.roleBadgeTxt}>SISWA</Text>
                  </View>
              </View>
           </ImageBackground>
        </View>
        ...
        <View style={styles.idCardWrapper}>
           <View style={styles.premiumCard}>
              ...
              <View style={styles.cardHeaderArea}>
                  <View>
                    <Text style={styles.cardTag}>KARTU AKSES SISWA</Text>
              ...
              <View style={styles.cardMainInfo}>
                  <View style={styles.infoCol}>
                     <View style={styles.idItemBox}>
                        <Text style={styles.idItemLabel}>NAMA LENGKAP</Text>
                        <Text style={styles.idItemVal}>{userData.nama || "N/A"}</Text>
                     </View>
                     <View style={styles.idItemBox}>
                        <Text style={styles.idItemLabel}>NIS (NOMOR INDUK SISWA)</Text>
                        <Text style={styles.idItemVal}>{userData.nis || userData.username || "N/A"}</Text>
                     </View>
                  </View>
              </View>
              ...
              <View style={styles.cardBottomBar}>
                 <View style={styles.validityBox}>
                    ...
                    <View style={styles.authRow}>
                       ...
                       <Text style={styles.authStatusTxt}>SISWA AKTIF</Text>
                    </View>
                 </View>
            ...
            <View style={styles.infoHub}>
               ...
               <View style={styles.infoHubItem}>
                  ...
                  <View style={styles.hubContent}>
                     ...
                     <Text style={styles.hubVal}>SISWA ELEKTIF (MBG)</Text>
                  </View>
               </View>
            </View>
         </View>
           ...
           <View style={styles.sheetMain}>
              ...
              <View style={styles.sheetHead}>
                 <View>
                    ...
                    <Text style={styles.sheetSubTxt}>Perbarui spesifikasi profil Siswa</Text>
                 </View>
...
const styles = StyleSheet.create({
  ...
  quickActionsContainer: { paddingHorizontal: 25, marginTop: 45 },
